...
class ElectricityBoardForm extends StatefulWidget {
  const ElectricityBoardForm({Key? key}) : super(key: key);

  @override
  State<ElectricityBoardForm> createState() => _ElectricityBoardFormState();
}

class _ElectricityBoardFormState extends State<ElectricityBoardForm> {  Position? _currentPosition;
